package com.lawencon.ticketms.config;
...
import com.lawencon.ticketms.filter.AuthorizationFilter;
import com.lawencon.ticketms.service.impl.UserServiceImpl;
...
public class SecurityConfig {
	...
	public AuthenticationManager authManager(HttpSecurity http, PasswordEncoder pwd, UserServiceImpl userService) throws Exception{
		return http.getSharedObject(AuthenticationManagerBuilder.class)
				.userDetailsService(userService).passwordEncoder(pwd).and().build();
	}
